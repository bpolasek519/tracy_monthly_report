...
def create_fs_wip_df(df: pd.DataFrame, title: str, filename: str, month: str = '', for_fs: bool = True) -> pd.DataFrame:
...
def create_fs_outstanding_df(df: pd.DataFrame, title: str, filename: str, month: str = '') -> pd.DataFrame:
